...
class ManagerProcess(ABC):
  ...
  phandler: Optional[psutil.Process] = None
  enabled = True
  name = ""
  ...
  def get_proc_msg(self):
    ...
    proc_msg.pid=self.proc.pid or 0
...
class NativeProcess(ManagerProcess):
  def __init__(self, name, cwd, cmdline, enabled=True, onroad=True, offroad=False, nowait=False, callback=None, unkillable=False, sigkill=False, watchdog_max_dt=None):
    self.name = name
    self.cwd = cwd
  ...
  def start(self) -> None:
    ...
    self.phandler = psutil.Process(self.proc.pid)
    self.proc.start()
...
class PythonProcess(ManagerProcess):
  def __init__(self, name, module, enabled=True, onroad=True, offroad=False, nowait=False, callback=None, unkillable=False, sigkill=False, watchdog_max_dt=None):
    self.name = name
    self.module = module
    self.enabled = enabled
    self.onroad = onroad
